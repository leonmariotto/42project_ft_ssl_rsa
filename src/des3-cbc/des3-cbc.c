...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/28 16:34:17 by lmariott          #+#    #+#             */
/*   Updated: 2021/08/28 19:23:48 by lmariott         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "des.h"

int                 des3_cbc_decrypt(void **ptr, const unsigned char *input, int *len)
{
    int             i;
    int             j;
    char            buf[8];
...
int                 des3_cbc_encrypt(void **ptr, const unsigned char *input, int *len)
{
    int             i;
    int             j;
    char            buf[8];
...
int                 des3_cbc(void **ptr, const unsigned char *input, int *len, char mod)
{
    ...
    if (!mod)
        r = des3_cbc_encrypt(ptr, input, len);
    else
        r = des3_cbc_decrypt(ptr, input, len);
    return (r);
}
