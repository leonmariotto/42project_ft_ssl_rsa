...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/23 13:22:20 by lmariott          #+#    #+#             */
/*   Updated: 2021/08/28 18:03:26 by lmariott         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "des.h"

void            exit_des_cbc(void)
{
...
int             run_des_cbc(void **av, int ac)
{
    unsigned char   *input;
    char            *ptr;
    char            *b64_ptr;
    ...
    if (!(des_cbc((void **)&ptr, input, &len, get_des()->opt->d)))
    {
        free(input);
	exit_des_cbc();
        return (0);
