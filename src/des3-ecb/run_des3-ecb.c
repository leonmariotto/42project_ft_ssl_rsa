...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/27 17:46:15 by lmariott          #+#    #+#             */
/*   Updated: 2021/08/28 18:01:26 by lmariott         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "des.h"

void            exit_des3_ecb(void)
{
...
int             run_des3_ecb(void **av, int ac)
{
    unsigned char   *input;
    char            *ptr;
    char            *b64_ptr;
    ...
    if (!(des3_ecb((void **)&ptr, input, &len, get_des()->opt->d)))
    {
        free(input);
	exit_des3_ecb();
        return (0);
