...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/23 11:08:53 by lmariott          #+#    #+#             */
/*   Updated: 2021/08/28 18:04:38 by lmariott         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "des.h"

void            exit_des_ecb(void)
{
...
int             run_des_ecb(void **av, int ac)
{
    unsigned char   *input;
    char            *ptr;
    char            *b64_ptr;
    ...
    if (!(des_ecb((void **)&ptr, input, &len, get_des()->opt->d)))
    {
        free(input);
	exit_des_ecb();
        return (0);
